...
if [ "$CONFIG_MODE" = "final" ]; then
  ...
  cp evaluation/new/HDFS-16984-config-format-vd-static.json hdfs_config.json
  diff evaluation/new/HDFS-16984-config-format-vd-static.json hdfs_config.json
elif [ "$CONFIG_MODE" = "base" ]; then
  echo "Using base config"
  cp evaluation/new/HDFS-16984-config-normal.json hdfs_config.json
  diff evaluation/new/HDFS-16984-config-normal.json hdfs_config.json
else
