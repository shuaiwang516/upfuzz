            ...
            cat > "${path}" <<JSON
{
  ...
  "candidateArtifactMaxFiles" : 64,
  "candidateArtifactMaxBytesPerFile" : 524288,
  "candidateArtifactMaxTotalBytes" : 4194304,
  "candidateTraceSnippetMaxEntries" : 500,
